    ...
    <section className="py-16 sm:py-24 bg-secondary/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            <span className="inline-flex items-center gap-2 text-xs sm:text-sm font-semibold tracking-wide uppercase text-accent mb-4">
              <MessageCircle className="h-4 w-4" />
              Alumni Advice
            </span>
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold text-foreground leading-tight mb-4 sm:mb-6">
            ...
            <Button
              ...
              className="rounded-full bg-accent text-accent-foreground hover:bg-accent/90 px-8 py-6 text-base font-semibold shadow-lg hover:shadow-xl transition-all hover:scale-105 w-full sm:w-auto"
            >
              Find Your Community
            </Button>
          </motion.div>
          ...
          {/* Chat bubbles */}
          <motion.div
            className="flex flex-col gap-3 sm:gap-4 max-w-md mx-auto lg:mx-0 lg:ml-auto"
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            {mockQuestions.map((q, i) => (
              ...
              >
                <div
                  className={`px-4 sm:px-5 py-3 sm:py-3.5 rounded-2xl text-sm shadow-md max-w-[85%] ${
                    q.align === "right"
