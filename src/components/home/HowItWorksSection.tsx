  ...
  return (
    <section className="py-16 sm:py-24 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-xs sm:text-sm font-medium tracking-widest uppercase text-erasmatch-green mb-3">How it works</p>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="relative p-5 sm:p-6 rounded-2xl hover:bg-card hover:shadow-card hover:scale-[1.03] transition-all duration-300 cursor-default">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed group-hover:text-foreground/70 transition-colors duration-300">{step.description}</p>
              </div>
            </motion.div>
          ))}
        </div>
