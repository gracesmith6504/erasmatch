  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: "appearance-none bg-secondary/60 border border-border rounded-lg px-3 py-1.5 text-sm font-medium cursor-pointer hover:bg-secondary transition-colors focus:outline-none focus:ring-2 focus:ring-primary/30",
        vhidden: "hidden",
        nav: "hidden",
        nav_button: cn(
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-10 font-medium text-xs uppercase tracking-wide",
